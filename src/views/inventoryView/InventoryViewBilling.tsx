          ...
          >
            ...
            <DialogContent sx={{ pt: 8, pl: [6, 15], pr: [6, 15] }}>
              ...
              >
                ...
                <Button color='error' variant='outlined' sx={{ mt: 2, display: 'flex', justifyContent: 'right', width: '100%' }} onClick={() => setSubscriptionDialogOpen(true)}>
                  Cancel Subscription
                </Button>
              </Box>
            </DialogContent>
      ...
      <Grid item xs={12}>
        <Card>
          ...
          <Dialog
            ...
            sx={{
              '& .MuiPaper-root': { width: '100%', maxWidth: 560 },
              '& .MuiDialogTitle-root + .MuiDialogContent-root': { pt: theme => `${theme.spacing(2)} !important` }
            }}
...
export default InventoryViewBilling
