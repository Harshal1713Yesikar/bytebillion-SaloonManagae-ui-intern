...
import InventoryViewNotification from './InventoryViewNotification'
...
const InventoryViewRight = ({ tab, invoiceData }: Props) => {
  // ** State
...
export default InventoryViewRight
