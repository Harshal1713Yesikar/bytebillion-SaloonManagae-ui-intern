...
import StudentViewNotification from './StudentViewNotification'
...
const StudentViewRight = ({ tab, invoiceData }: Props, props: Props) => {
  // ** State
        ...
        {isLoading ? (
          ...
          <>
            <TabPanel value='account'>
              <StudentViewAccount updateCollegeState={updateCollegeState} setUpdateCollegeState={setUpdateCollegeState} />
            </TabPanel>
